            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_home:
                        Toast.makeText(MainActivity.this, "action_home", Toast.LENGTH_SHORT).show();
                        //fragment = fragment1;
                        break;
                    case R.id.action_compose:
                        Toast.makeText(MainActivity.this, "action_compose", Toast.LENGTH_SHORT).show();
                        //fragment = fragment2;
                        break;
                    case R.id.action_profile:
                        Toast.makeText(MainActivity.this, "action_profile", Toast.LENGTH_SHORT).show();
                    default:
                        //fragment = fragment3;
                        break;
                }
